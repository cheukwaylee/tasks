...
@empty_1 = internal unnamed_addr constant [11 x i8] c"bbgemm_top\00"  ; name of top function
@empty_2 = internal unnamed_addr constant [9 x i8] c"loop_add\00"     ; name of loop

; Function Attrs: nounwind
define void @bbgemm_top([4096 x i32]* noalias %m1, [4096 x i32]* noalias %m2, [4096 x i32]* noalias %prod) #0 {
  %i = alloca i13, !bitwidth !30

  call void (...)* @_ssdm_op_SpecTopModule([11 x i8]* @empty_1) #0 ; set top function name
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(
    [4096 x i32]* %m1
    ) #0, !map !31
...
; <label>:1                                       ; preds = %.split, %0
  ...
  %icmp_ln23 = icmp eq i13 %i_1, -4096, !bitwidth !46
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 4096, i64 4096, i64 4096) #0
  %add_ln23 = add i13 %i_1, 1, !bitwidth !39
  br i1 %icmp_ln23, label %2, label %.split, !llvm.loop !47, !bitwidth !32

.split:                                           ; preds = %1
  %i_cast = zext i13 %i_1 to i64, !bitwidth !49
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @empty_2) #0
  ...
  %add_ln33 = add nsw i32 %m2_load, %m1_load, !bitwidth !50
  %prod_addr = getelementptr [4096 x i32]* %prod, i64 0, i64 %i_cast, !bitwidth !7
  store i32 %add_ln33, i32* %prod_addr, align 4, !bitwidth !32
  store i13 %add_ln23, i13* %i, !bitwidth !32, !dep_idx !51, !deps !52
...
!27 = metadata !{[9 x i8]* @empty_2, metadata !13}
...
!48 = metadata !{metadata !"llvm.loop.name", metadata !"loop_add"}
